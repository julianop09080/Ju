...
import { getAuth, GoogleAuthProvider } from "firebase/auth"; // For Authentication (optional)
...
export { app, auth, db, analytics, googleProvider, storage }; // Export the services
